...
#ifndef SRC_FUSE_MOE_WARP_DECODE_H_
#define SRC_FUSE_MOE_WARP_DECODE_H_
...
// SM90 route-direct implementation: Gate/Up WGMMA can split K for decode
...
#endif  // SRC_FUSE_MOE_WARP_DECODE_H_
